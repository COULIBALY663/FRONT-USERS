...
export default function Casier() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:3000/casier", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    <div style={containerStyle}>
      <h1 style = {{ textAlign: "center",  backgroundColor: "orange", color: "#fff", padding: "10px" }}>📄 DEMANDE DE CASIER JUDICIAIRE</h1>
